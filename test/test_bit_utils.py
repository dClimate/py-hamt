...
def test_set_bit():
    ...
    assert set_bit(bytes([0b0, 0b11111111]), 8 + 0, 1) == bytes(
        ([0b0, 0b11111111])
    )
    assert set_bit(bytes([0b0, 0b11111111]), 8 + 7, 1) == bytes(
        ([0b0, 0b11111111])
    )
    assert set_bit(bytes([0b0, 0b01010101]), 8 + 1, 1) == bytes(
        ([0b0, 0b01010111])
    )
    assert set_bit(bytes([0b0, 0b01010101]), 8 + 7, 1) == bytes(
        ([0b0, 0b11010101])
    )
    assert set_bit(bytes([0b0, 0b11111111]), 8 + 0, 0) == bytes(
        ([0b0, 0b11111110])
    )
    assert set_bit(bytes([0b0, 0b11111111]), 8 + 1, 0) == bytes(
        ([0b0, 0b11111101])
    )
    assert set_bit(bytes([0b0, 0b11111111]), 8 + 7, 0) == bytes(
        ([0b0, 0b01111111])
    )
